...
public class Standalone extends BaseActivity implements CameraDialog.CameraDialogParent {
    ...
    private final OnClickListener mOnClickListener = new OnClickListener() {
        ...
        public void onClick(final View view) {
            if (mUVCCamera == null) {
                ...
                CameraDialog.showDialog(Standalone.this);
            } else {
                synchronized (mSync) {
                    mUVCCamera.destroy();
                    mUVCCamera = null;
    ...
    private final OnDeviceConnectListener mOnDeviceConnectListener = new OnDeviceConnectListener() {
        ...
        public void onAttach(final UsbDevice device) {
            ...
            Toast.makeText(Standalone.this, "USB_DEVICE_ATTACHED", Toast.LENGTH_SHORT).show();
        }
        ...
        public void onDettach(final UsbDevice device) {
            ...
            Toast.makeText(Standalone.this, "USB_DEVICE_DETACHED", Toast.LENGTH_SHORT).show();
        }
